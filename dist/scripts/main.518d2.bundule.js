"use strict";
(self["webpackChunkweb3_education_interface"] = self["webpackChunkweb3_education_interface"] || []).push([[179],{
...
;// CONCATENATED MODULE: ./src/hooks/useImmer.ts
...
function useImmer(initialValue) {
    const [val, updateValue] = (0,react.useState)(()=>freeze(typeof initialValue === 'function' ? initialValue() : initialValue, true));
    return [
        val,
        (0,react.useCallback)((updater)=>{
...
const getDefaultStore = () => {
  if (!defaultStore) {
    defaultStore = vanilla_createStore();
  }
  return defaultStore;
};
...
;// CONCATENATED MODULE: ./node_modules/jotai-immer/dist/index.modern.js
function e(r){const n=atom(r,(o,r,e)=>r(n,produce(o(n),"function"==typeof e?e:()=>e)));return n}const i=new WeakMap;function f(r){return n=()=>o(t=>t(r),(o,n,e)=>n(r,t(o(r),"function"==typeof e?e:()=>e))),(i.has(e=r)?i:i.set(e,n())).get(e);var n,e}function a(o,e){const[i,f]=n(o,e);return[i,r(o=>f(t(o)),[f])]}
...
const App = ()=>{
    const [YiDeng, setYiDeng] = useImmer({
        statusCode: 1,
        result: [
            1
        ]
...
;// CONCATENATED MODULE: ./src/wdyr.tsx
